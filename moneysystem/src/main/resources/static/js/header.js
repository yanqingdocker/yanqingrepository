...
document.writeln(" <li class=\"nav-item\"><a href=\"/index\" id=\"nav_index\">首页</a></li>");
...
document.writeln("  </div> ");
document.writeln("  </li>");
document.writeln("<li class=\"nav-item\"><a href=\"/main/recharge\" id=\"nav_recharge\">充值</a></li>");
document.writeln(" <li class=\"nav-item\"><a href=\"/main/trans_cash\" id=\"nav_trans\">提现</a></li>");
document.writeln("  <li class=\"nav-item\"><a href=\"/main/transfer_accounts\" id=\"nav_transfer\">转账</a></li>");
document.writeln("<li class=\"nav-item\"><a href=\"/currency_exchange/exchange\" id=\"nav_exchange\">货币兑换</a></li>");
document.writeln(" <li class=\"nav-item\"><a href=\"/nonCardCash/cash_in\" id=\"nav_nocard\">无卡取现</a></li>");
document.writeln(" <li class=\" dropdown nav-item\">");
document.writeln(" <a class=\"nav-link dropdown-toggle\" id=\"nav_more\">更多<i class=\"icon_down\"></i></a>");
document.writeln(" <div class=\"dropdown-menu \" style=\"display: none\">");
document.writeln(" <a class=\"dropdown-item\" href=\"/more/financial\">智慧理财</a>");
